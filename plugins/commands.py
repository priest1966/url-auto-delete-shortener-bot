...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/+yOiSzPgpp70yYjI1')
            ],
            [
                InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url=f"https://t.me/ott_freakx_backup"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='https://t.me/ott_freakx_backup'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/+yOiSzPgpp70yYjI1')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/ott_freakx_backup') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
